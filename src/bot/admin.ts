  ...
  bot.command("help", async (ctx) => {
    await ctx.reply(
      [
        ...
        "",
        "Admins: /start to add a token, then set min buy, emoji, GIF (send a GIF in chat), whale size, and chart.",
        ...
        "<b>Whale</b> = buys at or above a USD size you set (default $500). Those use the whale GIF and 🐋.",
